...
export let options = {
  stages: [
    ...
    { duration: '2m', target: 1500 }, // Stress Test: จำนวนผู้ใช้สูงสุด 1500 คน ใน 2 นาที
...
export default function () {
  ...
  check(sortTopRes, {
    ...
    '/t/general?sort=top response time < 200': (r) => r.timings.duration < 200,
  });
  ...
  check(sortNewestRes, {
    ...
    '/t/general?sort=newest response time < 200': (r) => r.timings.duration < 200,
  });
  ...
  check(sortOldestRes, {
    ...
    '/t/general?sort=oldest response time < 200': (r) => r.timings.duration < 200,
  });
